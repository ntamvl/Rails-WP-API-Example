...
ActiveRecord::Schema.define(version: 20150626031816) do

  create_table "mnc_category", primary_key: "code", force: :cascade do |t|
    t.string  "title", limit: 1000, null: false
    t.string  "link",  limit: 1000, null: false
    t.integer "order", limit: 4,    null: false
  end

  create_table "mnc_movie", primary_key: "code", force: :cascade do |t|
    t.string   "title",       limit: 1000,              null: false
    t.string   "genres",      limit: 1000,              null: false
    t.string   "vintage",     limit: 500,               null: false
    t.string   "status",      limit: 500,               null: false
    t.text     "summary",     limit: 65535,             null: false
    t.string   "cover",       limit: 1000,              null: false
    t.string   "slug",        limit: 1000,              null: false
    t.string   "category",    limit: 36,                null: false
    t.string   "other_title", limit: 1000,              null: false
    t.string   "ref",         limit: 1000,              null: false
    t.datetime "updated",                               null: false
    t.integer  "onair",       limit: 4,     default: 0, null: false
    t.integer  "popular",     limit: 4,     default: 0, null: false
  end

  create_table "mnc_page", primary_key: "code", force: :cascade do |t|
    t.string "title", limit: 1000,  null: false
    t.string "slug",  limit: 1000,  null: false
    t.text   "data",  limit: 65535, null: false
  end

  create_table "mnc_search_keyword", force: :cascade do |t|
    t.string "keyword", limit: 1000, null: false
  end

  create_table "mnc_search_link", force: :cascade do |t|
    t.string "code",    limit: 36,   null: false
    t.string "slug",    limit: 1000, null: false
    t.string "title",   limit: 1000, null: false
    t.string "summary", limit: 8000, null: false
  end

  create_table "mnc_seo", primary_key: "code", force: :cascade do |t|
    t.string "keywords",    limit: 1000, null: false
    t.string "description", limit: 1000, null: false
  end

  create_table "mnc_topmenu", primary_key: "code", force: :cascade do |t|
    t.string  "title", limit: 1000, null: false
    t.string  "link",  limit: 1000, null: false
    t.integer "order", limit: 4,    null: false
  end

  create_table "mnc_user", primary_key: "code", force: :cascade do |t|
    t.string "username", limit: 200,  null: false
    t.string "password", limit: 500,  null: false
    t.string "rights",   limit: 1000, null: false
  end

  create_table "mnc_video", primary_key: "code", force: :cascade do |t|
    t.string   "title",    limit: 1000,               null: false
    t.string   "slug",     limit: 1000,               null: false
    t.text     "data",     limit: 65535,              null: false
    t.integer  "order",    limit: 4,                  null: false
    t.string   "movie",    limit: 36,                 null: false
    t.string   "ref",      limit: 1000,               null: false
    t.datetime "updated",                             null: false
    t.integer  "episode",  limit: 4,     default: 0,  null: false
    t.integer  "upcoming", limit: 4,     default: 0,  null: false
    t.integer  "recent",   limit: 4,     default: 0,  null: false
    t.string   "mp4",      limit: 1000,  default: "", null: false
  end

  add_index "mnc_video", ["movie"], name: "fk_rails_0f3632d670", using: :btree

  create_table "mnc_widget", primary_key: "code", force: :cascade do |t|
    t.string "slug", limit: 200,   null: false
    t.text   "data", limit: 65535, null: false
  end

  add_index "mnc_widget", ["slug"], name: "slug", unique: true, using: :btree
  ...
  add_foreign_key "mnc_video", "mnc_movie", column: "movie", primary_key: "code", name: "fk_videos_movie"
end
